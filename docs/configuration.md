...
Compact console tool-call summaries include successful read, inspect, edit, write, command, and task calls, using fixed columns in the form `workspace | kind | tool | status | duration | details`.
