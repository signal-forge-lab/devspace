...
import {
  publishWorkbridgeConsoleLine,
  workbridgeConsoleLine,
...
export function logEvent(
  ...
  const compactLine = workbridgeConsoleLine(event, fields);
  if (compactLine === undefined && !config.consoleJson) return;
  ...
  publishWorkbridgeConsoleLine(level, event, fields, entry, line);
}
